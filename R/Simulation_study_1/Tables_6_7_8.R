...
save.image(paste0("Scenario", Scenario, "_all_models_cor", Subscenario, ".Rdata"))
...
Tab.beta1 <- rbind(Null.beta1, Spat.beta1, RSR.beta1,
...
rownames(Tab.beta1) <- c("Null", "Spatial", "RSR","SpatPlus5", "SpatPlus10", 
...
Table.est <- data.frame(Null=est.beta1(Null), Spat=est.beta1(Spat), RSR=est.beta1(RSR),
                        SpatPlus5=est.beta1(SpatPlus5), SpatPlus10=est.beta1(SpatPlus10), 
                        SpatPlus15=est.beta1(SpatPlus15), SpatPlus20=est.beta1(SpatPlus20), 
                        SpatPlusP1=est.beta1(SpatPlusP1), SpatPlusTP1=est.beta1(SpatPlusTP1), 
                        SpatPlusP2=est.beta1(SpatPlusP2), SpatPlusTP2=est.beta1(SpatPlusTP2))


Table.sim <- data.frame(Null=sim.beta1(Null), Spat=sim.beta1(Spat), RSR=sim.beta1(RSR),
                        SpatPlus5=sim.beta1(SpatPlus5), SpatPlus10=sim.beta1(SpatPlus10), 
                        SpatPlus15=sim.beta1(SpatPlus15), SpatPlus20=sim.beta1(SpatPlus20), 
                        SpatPlusP1=sim.beta1(SpatPlusP1), SpatPlusTP1=sim.beta1(SpatPlusTP1), 
                        SpatPlusP2=sim.beta1(SpatPlusP2), SpatPlusTP2=sim.beta1(SpatPlusTP2))


colnames(Table.est) <- c("Null", "Spatial", "RSR",
...
Table.sim.est[, 1:11] <- round(Table.sim.est[, 1:11], 4)
