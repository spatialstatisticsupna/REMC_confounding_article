...
load(paste0("Results_SimuStudy1/Scenario", Scenario, "_TGMRF_GSC_cor", Subscenario, ".Rdata"))
...
save(TGMRF.GSC, WAIC.GSC, 
     file=paste0("Results_SimuStudy1/Scenario", Scenario, "_summary_TGMRF_GSC_cor", Subscenario, ".Rdata"))
