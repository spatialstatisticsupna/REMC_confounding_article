...
SpatPlus5 <- SpatPlus
save(SpatPlus5, file=paste0("Results_SimuStudy1/Scenario", Scenario, "_SpatPlus5_cor", Subscenario, ".Rdata"))

# SpatPlus10 <- SpatPlus
# save(SpatPlus10, file=paste0("Results_SimuStudy1/Scenario", Scenario, "_SpatPlus10_cor", Subscenario, ".Rdata"))

# SpatPlus15 <- SpatPlus
# save(SpatPlus15, file=paste0("Results_SimuStudy1/Scenario", Scenario, "_SpatPlus15_cor", Subscenario, ".Rdata"))

# SpatPlus20 <- SpatPlus
# save(SpatPlus20, file=paste0("Results_SimuStudy1/Scenario", Scenario, "_SpatPlus20_cor", Subscenario, ".Rdata"))
