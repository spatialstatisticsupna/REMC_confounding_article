...
source("R/Real_data_analysis/Covariate_model_eigenvectors.R")
...
source("R/Real_data_analysis/Covariate_model_Psplines.R")
...
source("R/Real_data_analysis/Covariate_model_TPsplines.R")
