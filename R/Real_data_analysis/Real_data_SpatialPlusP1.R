...
SpatPlusP1 <- inla(f.SpatPlus, family="poisson", data=Data, E=E,
                 control.predictor=list(compute=TRUE, cdf=c(log(1))),
                 control.compute=list(dic=TRUE, cpo=TRUE, waic=TRUE),
                 control.inla=list(strategy=strategy))


save(SpatPlusP1, file="Results_Uttar/SpatPlusP1_SexRatio.Rdata")
# save(SpatPlusP1, file="Results_Slovenia/SpatPlusP1_SE.Rdata")
#save(SpatPlusP1, file="Results_Scotland/SpatPlusP1_AFF.Rdata")
