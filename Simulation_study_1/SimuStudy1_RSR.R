...
f.RSR <- O ~ -1 + Intercept + beta1 + f(ID.area, model="besag", graph=Q.xi, rankdef=1, 
...
save(RSR, file=paste0("Results_SimuStudy1/Scenario", Scenario, "_RSR_cor", Subscenario, ".Rdata"))
